    ...
    <div className="h-full overflow-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-semibold text-primary">Worker / Endpoint Spend</h1>
            <p className="text-xs text-muted">Remote compute cost breakdown by endpoint</p>
          </div>
        </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-elevated">
              <th className="text-left px-4 py-2.5 text-xs font-medium text-muted">Endpoint</th>
              ...
              <th className="text-left px-4 py-2.5 text-xs font-medium text-muted">Failed</th>
              <th className="text-left px-4 py-2.5 text-xs font-medium text-muted">Tokens</th>
          ...
          <tbody>
            {loading ? (
              ...
              data.map((row) => {
                ...
                return (
                  <tr key={row.endpointId} className="border-b border-border last:border-0 hover:bg-elevated/30">
                    ...
                    <td className="px-4 py-3 text-xs">
                      <span className={failRate > 0.1 ? 'text-red-400' : 'text-muted'}>
                        {row.failedRequests}
