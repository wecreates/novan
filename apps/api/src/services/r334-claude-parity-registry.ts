...
export const CLAUDE_PARITY: ClaudeParityCapability[] = [
  ...
  // ─── Memory ──────────────────────────────────────────────────────────
  {
    ...
    closureCost: 'medium',
    evidence: 'workspace_memory + memory-tier-system exists',
  },
  {
  ...
  // ─── Multimodal ──────────────────────────────────────────────────────
  {
    ...
    closureCost: 'medium',
    evidence: 'media-analyzer + image-creative-graph exist',
  },
  {
  ...
  },
  {
    ...
    closureCost: 'small',
    evidence: 'r327-onboarding + clarify_events exist',
  },
  ...
  // ─── Safety ──────────────────────────────────────────────────────────
  {
    ...
    closureCost: 'small',
    evidence: 'money-guard exists; needs full policy taxonomy',
  },
  {
  ...
  },
  {
    ...
    closureCost: 'large',
    evidence: 'self-improvement-loop exists; needs to consume this registry',
  },
  {
